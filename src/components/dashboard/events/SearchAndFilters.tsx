  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4 sm:p-[20px] p-[15px] items-start lg:items-center justify-between bg-white rounded-[20px] shadow-[0_16px_32px_-12px_rgba(88,92,95,0.10)]">
      ...
      <div className="relative w-full lg:w-[400px]">
        ...
        <input
          type="text"
          placeholder="Search events, types, status..."
          value={searchQuery}
          onChange={(e) => onSearchChange(e.target.value)}
          className="w-full pl-10 pr-4 py-2.5 bg-[#EEF2FF] rounded-[50px] text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
