  ...
  return (
    <section className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen">
      <div className="px-4 md:px-8">
        <div className="bg-linear-to-r w-full left-0 from-brand-primary to-[#952800] px-4 py-20 text-white text-center flex flex-col gap-4 items-center justify-center">
